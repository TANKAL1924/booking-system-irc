...
const initialEvents: Event[] = [
  { id: 1, title: 'NS State Hockey Championship 2026', category: 'Tournament', date: '2026-05-10', time: '8:00 AM', venue: 'Hockey Turf', description: 'Annual state-level hockey championship featuring top teams from across Negeri Sembilan.', image: '', status: 'Published' },
  { id: 2, title: 'Graduation Ceremony Package 2026', category: 'Events', date: '2026-06-15', time: '9:00 AM', venue: 'Banquet Hall', description: 'Premium graduation ceremony packages for schools and universities. Capacity up to 900 pax.', image: '', status: 'Published' },
  { id: 3, title: 'Soccer Veteran League Season 5', category: 'Sports', date: '2026-05-01', time: '4:00 PM', venue: 'Upper Field', description: 'Season 5 of the veteran soccer league. Open to players aged 35 and above.', image: '', status: 'Draft' },
  { id: 4, title: 'Ramadan Special Booking Rates', category: 'Promotion', date: '2026-04-20', time: 'All Day', venue: 'All Facilities', description: 'Special discounted rates during Ramadan month for all facility bookings.', image: '', status: 'Published' },
];
