...
export default function MembershipHeroSection() {
  return (
    <section className="relative pt-32 pb-12 px-6 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,215,0,0.06)_0%,transparent_60%)] pointer-events-none" />
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <h1 className="font-black leading-[0.85] tracking-tighter text-white mb-4" style={{ fontSize: 'clamp(2.8rem, 8vw, 6rem)' }}>
          BECOME A<br />
          <span className="gradient-text-brand">MEMBER</span>
        </h1>
      </div>
    </section>
  );
