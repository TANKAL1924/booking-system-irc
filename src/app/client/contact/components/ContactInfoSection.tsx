      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-card rounded-2xl p-6 space-y-5">
              ...
              {base?.email_2 && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-white mb-1">Email 2</p>
                    <a
          ...
          <div className="space-y-6">
            ...
            {/* Quick WhatsApp */}
            <a
              href={`https://wa.me/${(base?.whatsapp ?? '60123456789').replace(/\D/g, '').replace(/^0/, '60')}?text=Hi%20Arena%20IRC%2C%20I%20have%20an%20enquiry.`}
              target="_blank"
              rel="noopener noreferrer"
